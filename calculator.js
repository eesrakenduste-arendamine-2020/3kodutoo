...
const x2Button = document.querySelector("[data-operation-x2]");
...
sqrtButton.addEventListener("click", (button) => {
  calculator.sqrtFunction(button.innerText);
  calculator.updateDisplay();
});

x2Button.addEventListener("click", (button) => {
  calculator.x2Function(button.innerText);
  calculator.updateDisplay();
});

percentageButton.addEventListener("click", (button) => {
  calculator.percentageFunction(button.innerText);
  calculator.updateDisplay();
});
